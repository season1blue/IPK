...
def get_args_parser():
    ...
    parser.add_argument('--tsbd', default='./tsbd',
...
def main(args):
    ...
    if global_rank == 0 and args.tsbd is not None:
        os.makedirs(args.tsbd, exist_ok=True)
        log_writer = SummaryWriter(log_dir=args.tsbd)
    else:
        log_writer = None
